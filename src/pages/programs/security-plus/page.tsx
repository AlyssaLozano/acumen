...
export default function SecurityPlusPage() {
  ...
  const schema = useMemo(
    () => ({
      ...
      '@type': 'Course',
      name: 'Cybersecurity Practitioner Program',
      description:
        'A comprehensive 12-week instructor-led program preparing students for the CompTIA Security+ certification exam. Covers all five exam domains: General Security Concepts (12%), Threats, Vulnerabilities & Mitigations (22%), Security Architecture (18%), Security Operations (28%), and Security Program Management & Oversight (20%). Online synchronous format - 20 hours per week. GNPEC-authorized institution in Augusta, Georgia.',
      url: 'https://acumencareeracademy.com/programs/security-plus',
      courseCode: 'SECPLUS-240',
      educationalCredentialAwarded: 'CompTIA Security+ Exam Readiness',
      timeRequired: 'PT240H',
      courseMode: 'online',
      inLanguage: 'en-US',
      provider: PROVIDER,
      ...
      teaches: [
        'CompTIA Security+ exam domain coverage',
