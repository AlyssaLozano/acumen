  ...
  return (
    <div className="min-h-screen bg-navy-900">
      ...
      <main>
                ...
                <div className="glass-card gold-border-glow p-8 rounded-2xl">
                  ...
                  <div className="space-y-0 divide-y divide-gold/10">
                    ...
                    <div className="py-3.5 flex items-center justify-between">
                      ...
                      <span className="font-sans text-ice text-sm font-medium">240 Clock Hours · Live Instructor-Led</span>
                    </div>
                    ...
                    <div className="py-3.5 flex items-start justify-between gap-4 bg-gold/3 -mx-8 px-8">
                      <div>
                        <span className="font-sans text-ice text-sm font-semibold block">Workforce-Sponsored (WIOA)</span>
                        <span className="font-mono text-steel/60 text-xs">Includes career support services package</span>
                      </div>
                      <span className="font-display text-gold text-xl font-bold shrink-0">$8,500</span>
                    </div>
                    <div className="py-3.5 flex items-center justify-between">
                      <span className="font-sans text-steel text-sm">Your Out-of-Pocket (if WIOA approved)</span>
        ...
        <section className="py-20 bg-navy-900">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-14 reveal-element">
              ...
              <p className="font-sans text-steel text-base max-w-2xl mx-auto mb-6">
              ...
              <div className="inline-flex items-center gap-3 glass-card border border-gold/20 px-5 py-3 rounded-full">
                <i className="ri-information-line text-gold text-sm" />
                <span className="font-sans text-steel text-sm">
                  The core Security+ training program is identical under both pathways - same live instruction, same tools, same 8-week format.
                </span>
              </div>
            </div>
        ...
        {/* Program quality callout */}
        <section className="py-16 bg-navy-900">
          <div className="max-w-7xl mx-auto px-6">
            <div className="glass-card border border-gold/20 rounded-2xl overflow-hidden reveal-element">
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gold/30 to-transparent" />
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 divide-y lg:divide-y-0 lg:divide-x divide-gold/10">
                {/* Left: program quality */}
                <div className="p-8">
                  <p className="font-mono text-gold text-xs tracking-widest mb-4">THE PROGRAM ITSELF</p>
                  <h3 className="font-display text-2xl font-bold text-ice mb-4 leading-snug">
                    Same Training. Same Tools.<br />
                    <span className="gold-text">Regardless of How You Pay.</span>
                  </h3>
                  ...
                  <div className="space-y-3">
                    {[
                      { icon: 'ri-live-line', text: 'Live, synchronous instruction every session' },
                      { icon: 'ri-tools-line', text: 'Real tools: Splunk, Wireshark, and more from day one' },
                      { icon: 'ri-group-line', text: 'Small cohort sizes for direct instructor access' },
                      { icon: 'ri-shield-check-line', text: 'GNPEC authorized · WIOA approved provider' },
                    ].map((item) => (
                      <div key={item.text} className="flex items-center gap-3">
                        <div className="w-7 h-7 flex items-center justify-center rounded-lg border border-gold/20 bg-gold/5 shrink-0">
                          <i className={`${item.icon} text-gold text-xs`} />
                        </div>
                        <span className="font-sans text-ice/80 text-sm">{item.text}</span>
                      </div>
                    ))}
                ...
                <div className="p-8">
                  <p className="font-mono text-gold text-xs tracking-widest mb-4">YOUR OPTIONS</p>
                  <h3 className="font-display text-2xl font-bold text-ice mb-6 leading-snug">
                    Two Ways In.
                  </h3>
                  <div className="space-y-4">
                    ...
                    <div className="p-5 rounded-xl border border-gold/30 bg-gold/5">
                      <div className="flex items-start justify-between gap-4 mb-2">
                        <div>
                          <p className="font-display font-bold text-gold text-base">Workforce-Sponsored (WIOA)</p>
                          <p className="font-sans text-steel text-xs mt-0.5">WorkSource covers tuition if you qualify</p>
                        </div>
                        <span className="font-display text-green-400 font-bold text-xl shrink-0">$0*</span>
                      </div>
                      <p className="font-mono text-steel/50 text-xs">*Out-of-pocket for approved students. Program tuition is $8,500 under this pathway.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-navy-900">
          <div className="max-w-4xl mx-auto px-6 text-center reveal-element">
            <div className="glass-card gold-border-glow p-12 rounded-2xl">
              ...
              <p className="font-sans text-steel text-base leading-relaxed max-w-xl mx-auto mb-4">
              ...
              <p className="font-sans text-steel text-sm leading-relaxed max-w-xl mx-auto mb-8">
                Either way, you get the same live instructor-led training, the same real SOC tools,
                and the same credential. WIOA just means you may not pay a dollar out of pocket.
              </p>
